...
public class UserForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (UsersDao.CheckIfAlready(User)) {
            ...
            //Scenario 16: Improper handling of sensitive data 2
            //Initialized a array pass and fetched the password at line no 239.
            final char[] UserPass = Password.getPassword();
            ...
            //at line 249 converted the value of pass from array to string in argument of UsersDao.AddUser()
            if (UsersDao.AddUser(User, String.valueOf(UserPass), UserEmail, Date) != 0) {
            ...
            //Erased the password when work is done
