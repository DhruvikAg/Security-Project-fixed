...
public class DeleteBook extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       //Scenario 15: Improper handling of sensitive data 1
       //Initialized a array pass and fetched the password at line no 128.
        final char[] Pass = password.getPassword();
       //at line 130 converted the value of pass from array to string in argument of LibrarianDao.validate()
        if (LibrarianDao.validate(UserName.getText(), String.valueOf(Pass))) {
