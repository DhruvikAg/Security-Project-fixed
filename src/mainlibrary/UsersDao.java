...
public class UsersDao {
    ...
    public static boolean validate(String name, String password) {
        ...
        try {
            //Scenario 2: User Login SQL Injection
            //Used parameterized SQL statements instead of concatenating user supplied strings
    ...
    public static boolean CheckIfAlready(String UserName) {
        boolean status = false;
        try {
            //Scenario 3: SQL Injection in CheckIfAlready() function
            //Used parameterized SQL statements instead of concatenating user supplied strings
            Connection con = DB.getConnection();
